...
void TemplateLayer::OnCreateBackBuffer()
{
    GraphicalLayer::OnCreateBackBuffer();
}

void TemplateLayer::OnInit()
{
    CreateRenderTarget();
    LoadAsset();
}

void TemplateLayer::OnDeInit()
{
    m_Camera.reset();
    ColorRT.reset();
    DepthRT.reset();
...
void TemplateLayer::OnUIRender(Timestep ts)
{
    /*
     * TODO Write your logic
     */
...
void TemplateLayer::OnChangeWindowSize(std::shared_ptr<ReEngine::Event> e)
{
    GraphicalLayer::OnChangeWindowSize(e);
}

void TemplateLayer::CreateRenderTarget()
{
